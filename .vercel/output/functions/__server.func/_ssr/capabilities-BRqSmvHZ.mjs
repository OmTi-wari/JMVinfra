...
import { S as Building2, a as ShieldCheck, g as HardHat, r as Truck, w as ArrowRight } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/capabilities-BRqSmvHZ.js
...
var capabilityPillars = [
	{
		...
		summary: "We coordinate design intent, procurement strategy, site mobilization, and commissioning in one accountable delivery chain so performance risk stays controlled from day one.",
		highlights: [
	...
	},
	{
		...
		summary: "Our civil and structural teams model geometry, drainage, load paths, and roadway performance to keep bridges, flyovers, and highway systems durable, safe, and efficient.",
		highlights: [
	...
	},
	{
		...
		summary: "From earthmoving spreads to paving and compaction sets, we build equipment readiness around productivity, maintenance discipline, and rapid site deployment.",
		highlights: [
		...
		image: "https://images.unsplash.com/photo-1581092919537-0f06d2658ee4?auto=format&fit=crop&w=1200&q=80"
	},
	{
		id: "pms",
		label: "Project management systems",
		title: "Controls that keep cost, schedule, and workforce synchronized.",
		summary: "Resource scheduling, cost visibility, issue tracking, and reporting cadence enable disciplined execution against critical milestones and client expectations.",
		highlights: [
	...
	},
	{
		...
		summary: "Our field and lab diagnostics validate concrete quality, bitumen performance, subgrade strength, and compaction so every layer meets specification before it proceeds.",
		highlights: [
	...
	},
	{
		...
		summary: "HSE is not a sub-function—it is embedded in pre-task planning, daily toolbox talks, hazard controls, and independent site audits that reinforce safe execution.",
		highlights: [
...
function CapabilitiesPage() {
	const [activePillar, setActivePillar] = (0, import_react.useState)(0);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "h-1.5 w-1.5 bg-[#E65100]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Capabilities & execution" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
								className: "mt-6 text-4xl font-extrabold tracking-[-0.06em] text-white md:text-6xl lg:text-7xl",
								children: "Engineering precision at massive scale."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-6 max-w-2xl text-base leading-8 text-white/80 md:text-lg",
								children: "From complex highway grids to high-capacity rail corridors, our integrated capabilities bridge engineering vision and physical execution."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
									...
									children: ["Initiate capability consultation", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "h-4 w-4" })]
									...
									children: "Explore project delivery"
								})]
							})
						]
					})
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-2 font-mono text-[10px] font-semibold uppercase tracking-[0.22em] text-[#E65100]",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "h-1.5 w-1.5 bg-[#E65100]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Capability matrix" })]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							className: "mt-5 text-3xl font-extrabold tracking-[-0.05em] text-[#2C1D11] md:text-4xl",
							children: "An execution model built for infrastructure complexity."
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "border border-[#2C1D11] bg-[#2C1D11] p-6 text-white md:p-8",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-2 font-mono text-[10px] font-semibold uppercase tracking-[0.22em] text-[#E65100]",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "h-1.5 w-1.5 bg-[#E65100]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Delivery logic" })]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-5 text-lg leading-8 text-white/80",
							children: "Our capability stack is structured around project control, site execution, and asset durability rather than isolated service silos."
						})]
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "overflow-hidden border border-[#E5E7EB] bg-white",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "flex flex-wrap gap-2 border-b border-[#E5E7EB] bg-[#F3F4F6] p-3 lg:p-4",
						children: capabilityPillars.map((pillar, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							onClick: () => setActivePillar(index),
							"aria-pressed": activePillar === index,
							className: ["border px-4 py-2 text-left text-[11px] font-semibold uppercase tracking-[0.12em] transition-all duration-200", activePillar === index ? "border-[#E65100] bg-[#E65100] text-white" : "border-[#E5E7EB] bg-white text-[#2C1D11]/75 hover:border-[#E65100]/40 hover:text-[#E65100]"].join(" "),
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "flex h-12 w-12 items-center justify-center border border-[#E5E7EB] bg-[#F3F4F6] text-[#E65100]",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: "h-5 w-5" })
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex items-center gap-2 font-mono text-[10px] font-semibold uppercase tracking-[0.22em] text-[#E65100]",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "h-1.5 w-1.5 bg-[#E65100]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: activeCapability.label })]
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
									className: "text-3xl font-extrabold tracking-[-0.05em] text-[#2C1D11] md:text-4xl",
									children: activeCapability.title
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-4 max-w-xl text-base leading-8 text-[#1A1A1A]/70",
									children: activeCapability.summary
								})] }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
									className: "grid gap-3 sm:grid-cols-2",
									children: activeCapability.highlights.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
							...
							className: "relative overflow-hidden border border-[#E5E7EB] bg-[#F3F4F6]",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-gradient-to-t from-[#2C1D11]/90 via-[#2C1D11]/25 to-transparent" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "absolute inset-x-0 bottom-0 p-5",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "grid grid-cols-2 gap-3",
										children: activeCapability.details.map((detail) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "border border-white/15 bg-[#2C1D11]/75 p-3 backdrop-blur-sm",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "text-[10px] font-semibold uppercase tracking-[0.16em] text-white/65",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "mx-auto max-w-7xl px-6 py-2 lg:px-10 lg:py-8",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mb-8 max-w-2xl",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center gap-2 font-mono text-[10px] font-semibold uppercase tracking-[0.22em] text-[#E65100]",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "h-1.5 w-1.5 bg-[#E65100]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Fleet readiness" })]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "mt-4 text-3xl font-extrabold tracking-[-0.05em] text-[#2C1D11] md:text-4xl",
						children: "Heavy machinery & fleet readiness"
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "grid gap-5 md:grid-cols-2 xl:grid-cols-4",
					children: equipmentCategories.map((equipment, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "h-1.5 w-1.5 bg-[#E65100]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: String(index + 1).padStart(2, "0") })]
								})
							]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "p-5",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
								className: "text-2xl font-bold tracking-[-0.04em] text-[#2C1D11]",
								children: equipment.title
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
								className: "mt-4 space-y-2 text-sm text-[#1A1A1A]/75",
								children: equipment.applications.map((application) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
									className: "flex items-start gap-2 border-l border-[#E5E7EB] pl-3",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mt-2 h-1.5 w-1.5 bg-[#E65100]",
										"aria-hidden": "true"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: application })]
								}, application))
							})]
						})]
					}, equipment.title))
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				className: "mt-20 bg-[#2C1D11] py-18 text-white",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-[0.9fr_1.1fr] lg:px-10",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-2 font-mono text-[10px] font-semibold uppercase tracking-[0.22em] text-[#E65100]",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "h-1.5 w-1.5 bg-[#E65100]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "HSE commitment" })]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							className: "mt-5 text-3xl font-extrabold tracking-[-0.05em] text-white md:text-5xl",
							children: "Quality and safety are engineered into every shift."
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-5 max-w-xl text-base leading-8 text-white/75",
							children: "We lead with prevention, verification, and continuous supervision so high-risk work remains controlled, traceable, and aligned with statutory and project standards."
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-8 inline-flex items-center gap-2 border border-[#E65100]/40 bg-[#E65100]/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.12em] text-[#F7C6A2]",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(HardHat, { className: "h-4 w-4" }), "Zero-accident objective"]
						})
					] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: [
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								...
								className: "mt-4 text-lg font-semibold leading-7 text-white",
								children: item
							})]
						}, item))
					})]
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				className: "mx-auto max-w-7xl px-6 py-16 lg:px-10",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "border border-[#E65100]/30 bg-[linear-gradient(135deg,_rgba(230,81,0,0.04),_rgba(230,81,0,0.12))] p-8 md:p-10 lg:flex lg:items-center lg:justify-between lg:gap-8",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "max-w-2xl",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-2 font-mono text-[10px] font-semibold uppercase tracking-[0.22em] text-[#E65100]",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "h-1.5 w-1.5 bg-[#E65100]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Capability consultation" })]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							className: "mt-4 text-3xl font-extrabold tracking-[-0.05em] text-[#2C1D11] md:text-4xl",
							children: "Require specialized turnkey execution for your upcoming infrastructure project?"
						})]
